...
// Returns a boolean for if the current inputs are valid
function validateInputs(teamArray) {
  if(teamArray.length !== 7){
    return "The array is not the length required for the simulator. Requires: 7, Received: " + teamArray.length;
  }
